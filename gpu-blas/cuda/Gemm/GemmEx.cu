...
namespace GpuBlas {
  ...
  namespace {
    ...
    using bgemm_f32_out_f32_acc = CublasGemmEx<Shapes::TypeConfig<__nv_bfloat16, float, float>, int>;
    using bgemm_f32_out_f32_acc_64 = CublasGemmEx<Shapes::TypeConfig<__nv_bfloat16, float, float>, int64_t>;
    BASELINER_REGISTER_WORKLOAD(bgemm_f32_out_f32_acc);
    BASELINER_REGISTER_WORKLOAD(bgemm_f32_out_f32_acc_64);
